      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3.5 border-b border-[#D2D2D7]/60 dark:border-white/10">
          ...
          {query && (
            <button
              onClick={() => setQuery('')}
              className="text-xs text-[#86868B] hover:text-[#1D1D1F] dark:hover:text-[#F5F5F7] px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/8"
            >
              Clear
            </button>
          )}
          <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[10px] font-mono text-[#86868B] bg-black/5 dark:bg-white/8 rounded border border-black/6 dark:border-white/6">
            ESC
          </kbd>
        </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-left text-xs transition-colors ${
                    isSelected
                      ...
                      : 'text-[#6E6E73] dark:text-[#A1A1A6] hover:bg-black/3 dark:hover:bg-white/4'
                  }`}
                >
                  <div className="flex items-center gap-3 min-w-0 pr-2">
                    <div className="shrink-0 w-6 h-6 rounded-lg bg-black/4 dark:bg-white/6 flex items-center justify-center">
                      {item.icon}
                    </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {item.badge && (
                      <span className="px-2 py-0.5 text-[10px] font-mono rounded bg-black/4 dark:bg-white/6 text-[#86868B]">
                        {item.badge}
                      </span>
                    )}
                    <ArrowRight
        ...
        {/* Footer shortcuts */}
        <div className="px-4 py-2 bg-black/2 dark:bg-white/2 border-t border-[#D2D2D7]/50 dark:border-white/10 flex items-center justify-between text-[11px] text-[#86868B]">
          <div className="flex items-center gap-3">
            <span>
              <kbd className="font-mono bg-black/4 dark:bg-white/8 px-1 py-0.5 rounded">↑</kbd>{' '}
              <kbd className="font-mono bg-black/4 dark:bg-white/8 px-1 py-0.5 rounded">↓</kbd> navigate
            </span>
            <span>
              <kbd className="font-mono bg-black/4 dark:bg-white/8 px-1 py-0.5 rounded">↵</kbd> select
            </span>
          </div>
