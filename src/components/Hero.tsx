...
export function Hero({ onSelectTab }: HeroProps) {
  ...
  return (
    <section className="pt-12 sm:pt-20 pb-12 sm:pb-16 max-w-4xl mx-auto">
      {/* Top Status Line */}
      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/[0.04] dark:bg-white/[0.06] border border-black/[0.06] dark:border-white/[0.08] mb-8 text-[13px] text-[#6E6E73] dark:text-[#A1A1A6]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-[#1D1D1F] dark:text-[#F5F5F7] bg-black/[0.04] dark:bg-white/[0.06] hover:bg-black/[0.08] dark:hover:bg-white/[0.1] border border-black/[0.06] dark:border-white/[0.08] transition-all"
            >
              Experience & Timeline
            </button>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-lg text-sm font-medium text-[#6E6E73] dark:text-[#A1A1A6] hover:text-[#1D1D1F] dark:hover:text-[#F5F5F7] hover:bg-black/[0.03] dark:hover:bg-white/[0.05] transition-all"
            >
        ...
        <div className="lg:col-span-4 flex flex-col items-center justify-center">
          <div
            ...
            className="w-full max-w-[280px] p-6 rounded-2xl bg-[#FFFFFF] dark:bg-[#1C1C1E] border border-black/[0.08] dark:border-white/[0.08] shadow-[0_4px_24px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)] transition-all duration-300 hover:border-blue-500/30"
          >
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-[11px] font-mono text-[#6E6E73] dark:text-[#A1A1A6] bg-black/[0.03] dark:bg-white/[0.04] px-2.5 py-1.5 rounded-md">
